...
for i = 0 : 1
    ...
    fig_path = ['../report/figures/poe', num2str(i)];
    ...
    title(['digit ', num2str(i)]);
    fig_path = ['../report/figures/margin', num2str(i)];
    saveas(gcf, fig_path, 'epsc');
    ...
    title(['digit ', num2str(i)]);
    fig_path = ['../report/figures/largest_weight', num2str(i)];
    saveas(gcf, fig_path, 'epsc');
    ...
    fig_path = ['../report/figures/three_fig', num2str(i)];
    saveas(gcf, fig_path, 'epsc');
    ...
    fig_path = ['../report/figures/weak_learner', num2str(i)];
    saveas(gcf, fig_path, 'epsc');
